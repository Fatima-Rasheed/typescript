...
var fvrtnum = 22;
var message = `My fvrt no is ${fvrtnum}`;
console.log(message);
...
var array = ["Ayeshyy Gull", "Hunain", "Wajdan", "Salar"];
...
var array = ["Ayeshyy Gull", "Hunain", "Wajdan", "Salar"];
var msg = "You are best character in this novel";
for (let i = 0; i < array.length; i++) {
...
var places = ["Turkey", "Saudi Arabia", "Singapur", "Naran", "London"];
...
var countries = ["Australia", "Canada", "Germany", "France", "China"];
...
//Q29 Favorite Fruit
var fruits = ["Mango", "Pear", "Watermelon", "Orange", "Grapes"];
var fruitchk = "Mango";
...
// Make new array
var fvrtfruits = ["Melon", "Berries", "Pomegranate"];
var chkfruits = "Melon";
...
var usernames = ["admin", "salar", "jahan", "adam", "faris"];
...
var curr_users = ["salar", "ali", "amir", "fatima", "mohsin"];
var new_users = ["bassam", "salar", "hurairah", "hassan", "amir"];
...
//Q34  Pizzas
var pizzas = ["Royal Crust", "Malai Boti", "Tikka Boti"];
...
var magiciansnames = ["Dynamo", "Merlin", "Teller"];
